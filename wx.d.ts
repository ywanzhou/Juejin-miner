...
declare namespace wx {
	...
	export function createGridAd(object: any);
	export function createBannerAd(object: any);
	export function navigateToMiniProgram(object: any);
	export function triggerGC();//加快触发垃圾回收

	export const cloud;
	export const aldStage;
	export function aldSendEvent(param: string);
	export function aldShareAppMessage(object: {
		title: string,
		imageUrl: string,
		ald_desc: string,//分享功能描述
	...
	export function aldOnShareAppMessage(callback: Function);
